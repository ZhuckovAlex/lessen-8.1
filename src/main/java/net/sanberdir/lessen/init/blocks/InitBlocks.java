...
import net.sanberdir.lessen.init.blocks.custom.FlameSaplings;
import net.sanberdir.lessen.init.items.InitItems;
import net.sanberdir.lessen.init.items.ModItemsGroup;
import net.sanberdir.lessen.init.trees.BrownTree;
...
public class InitBlocks {
    ...
    public static final RegistryObject<Block> BROWN_SAPLING = BLOCKS.register("brown_sapling",
            () -> new FlameSaplings(new BrownTree(), AbstractBlock.Properties.create(Material.PLANTS)
